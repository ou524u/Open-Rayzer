...
| Model               | re10k (SSIM) | re10k (PSNR) | re10k (LPIPS) | dl3dv (SSIM) | dl3dv (PSNR) | dl3dv (LPIPS) |
|---------------------|--------------|--------------|---------------|--------------|--------------|---------------|
| LVSM (ours)         | 0.822        | 25.80        | 0.182         | 0.684        | 23.12        | 0.282         |
...
If you are interested in how LVSM-stream methods developed and achieve success, we recommend a unique perspective in our paper [The Less You Depend, The More You Learn](https://pku-vcl-geometry.github.io/Less3Depend/).
